...
Channel.fromPath(params.out).into {out_ch1; out_ch2; out_ch3; out_ch4; out_ch5; out_ch6; out_ch7; out_ch8; out_ch9; out_ch10; out_ch11; out_ch12; out_ch13}
...
//	file '*_gProfiler_plot.png' into void_ch
	...
	"""
	Rscript $script/gprofiler_local.R --query $query --organism $organism --out $o/images
	"""
}
