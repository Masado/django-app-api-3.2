...
// nextflow run post_rnaseq_pipeline_scripts_directory.nf --fasta data/reads/*_R{1,2}.fastq --samples data/samples_rerun_conditions.txt --salmon data/salmon/ --compare data/compare.tsv --annotation data/Sus_scrofa.Sscrofa11.1.98.gtf --scripts ../scripts/ --species 9823 --geneFile Gallus_gallus_R11_Pathway_1.sif --query test_out/Gallus_gallus_Pathway_1_genes.txt --organism test_out/species.txt --org_tex test_out/species.tex --out test_out --network test_out/StringNetwork-Gallusgallus_reduced.sif --pathways 3 --kmin 0 -- kmax 5 -- kstep 1 --lmin 0 --lmax 3 --lstep 1
// chicken species id - 9031


params.reads = 'data/reads/*_R{1,2}.fastq'
params.ref = 'data/reference/Gallus_gallus.GRCg6a.98.gtf'
params.fasta = 'data/reference/Gallus_gallus.GRCg6a.dna.toplevel.fa'
params.samples = 'samples_extended.txt'
params.salmon = 'results_chicken_first40_test/salmon/'
params.tx2 = 'results_chicken_first40_test/salmon/tx2gene.csv'
params.compare = 'chicken_compare.tsv'
params.annotation = 'data/reference/Gallus_gallus.GRCg6a.98.gtf'
...
params.lmax = 3
params.lstep = 1
params.org_tex = 'test_out/species.tex'
params.tex_image = 'test_out/tex_files/images'
params.the_tex = 'test_out/tex_files/report4.tex'
