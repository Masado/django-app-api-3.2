...
CREATE TABLE public.run_run (
    ...
    pipeline_command character varying(200),
...
COPY public.run_run (id, run_id, pipeline, exit_status, pipeline_command, start_time) FROM stdin;
48	UtMZIzzFTgAZ5Nk8	nf-core/RNA-Seq	\N	\N	12:47:51.026232
49	Ur1WvyrsIfmoyOM3	nf-core/RNA-Seq	0	nextflow run nf-core/rnaseq -r 3.3 --input samplesheet_test_local.csv --max_memory 8.GB --max_cpus 8 --genome R64-1-1 --star_index star --aligner star_salmon	12:56:45.597647
\.
...
SELECT pg_catalog.setval('public.run_run_id_seq', 49, true);
