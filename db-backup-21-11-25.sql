...
--
-- Name: run_run; Type: TABLE; Schema: public; Owner: next_django
--

CREATE TABLE public.run_run (
    id bigint NOT NULL,
    run_id character varying(100) NOT NULL,
    pipeline character varying(100) NOT NULL,
    exit_status character varying(50),
    pipeline_command character varying(600),
    start_time time without time zone NOT NULL,
    duration character varying(10)
);


ALTER TABLE public.run_run OWNER TO next_django;

--
-- Name: run_run_id_seq; Type: SEQUENCE; Schema: public; Owner: next_django
--
...
ALTER TABLE public.run_run_id_seq OWNER TO next_django;

--
-- Name: run_run_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: next_django
--

ALTER SEQUENCE public.run_run_id_seq OWNED BY public.run_run.id;
...
--
-- Name: run_run id; Type: DEFAULT; Schema: public; Owner: next_django
--

ALTER TABLE ONLY public.run_run ALTER COLUMN id SET DEFAULT nextval('public.run_run_id_seq'::regclass);
...
37	Can add run	10	add_run
38	Can change run	10	change_run
39	Can delete run	10	delete_run
40	Can view run	10	view_run
\.
...
1	pbkdf2_sha256$260000$k1I4rtFJmHnBbAIhp4jHel$V+OJ+0GbTgtC0nkv78C3Vec3BczGikiT5yLWGmFWYGM=	2021-11-18 18:19:52.114822+00	t	admin				t	t	2021-11-03 21:37:59.830178+00
\.
...
27	2021-11-17 15:42:54.144292+00	41	8zCuxQiXBXAqiMNm	3		10	1
28	2021-11-17 15:42:54.149354+00	7	nodDL53eaSRTaJUF	3		10	1
29	2021-11-17 15:42:54.150158+00	6	R1o3Kw0kyrAkhHWg	3		10	1
30	2021-11-18 12:46:28.871992+00	47	mWq3K2A4Szb3v3XD	3		10	1
31	2021-11-18 12:46:28.883064+00	46	KVoTvRxY8fwbQmWn	3		10	1
32	2021-11-18 12:46:28.886041+00	45	VzcrUHhfODzBmsjY	3		10	1
33	2021-11-18 12:46:28.889021+00	44	feTxvlNXhp251JBu	3		10	1
34	2021-11-18 12:46:28.891889+00	43	F6vK86WXRlekrYu7	3		10	1
35	2021-11-18 12:46:28.894711+00	42	PknvyUxRn2qTmx8l	3		10	1
\.
...
20	run	0001_initial	2021-11-17 14:41:17.046148+00
21	run	0002_auto_20211117_1623	2021-11-17 15:23:42.532697+00
22	run	0003_run_end_time	2021-11-17 15:26:00.128026+00
23	run	0004_remove_run_end_time	2021-11-17 15:28:13.32691+00
24	run	0005_alter_run_start_time	2021-11-17 15:30:32.131262+00
57	run	0006_alter_run_start_time	2021-11-17 15:36:49.188127+00
58	run	0007_alter_run_start_time	2021-11-17 15:43:25.427293+00
59	run	0008_alter_run_start_time	2021-11-18 12:45:58.648765+00
60	run	0009_alter_run_start_time	2021-11-18 12:56:00.533057+00
61	run	0010_run_date	2021-11-25 09:10:17.063123+00
62	run	0011_remove_run_date	2021-11-25 09:10:17.066642+00
63	run	0012_auto_20211124_1828	2021-11-25 09:10:17.077815+00
64	run	0013_remove_run_date	2021-11-25 09:10:17.0822+00
65	run	0014_run_duration	2021-11-25 10:14:20.231349+00
66	run	0015_alter_run_pipeline_command	2021-11-25 10:37:14.278346+00
67	run	0016_alter_run_duration	2021-11-25 10:42:27.645569+00
\.
...
1oasx7xy4o5cq4zi32zxvzu19fqf7nok	.eJxVjDkOwjAUBe_iGlnxEsdQ0ucM1t-MA8iR4qRC3B0ipYD2zcx7qQTbWtLWZEkTq4sy6vS7IdBD6g74DvU2a5rrukyod0UftOlxZnleD_fvoEAr33rwOVoXsnBEyuiHzBIpspzBOYMUPVoMnbAxHqHvwBrB3kGwBAJW1PsDEq05PQ:1mnm0m:xUXSa1EB6punaLHhBN1wKYtADrRgwEmVtr6gAmZ5JU8	2021-12-02 18:19:52.116856+00
\.
...
--
-- Data for Name: run_run; Type: TABLE DATA; Schema: public; Owner: next_django
--

COPY public.run_run (id, run_id, pipeline, exit_status, pipeline_command, start_time, duration) FROM stdin;
112	YzzGPmy2LaPMOfIc	nf-core/RNA-Seq	0	nextflow run nf-core/rnaseq -r 3.3 --input samplesheet_test_local.csv --max_memory 8.GB --max_cpus 8 --fasta genome.fa --gtf genes.gtf --star_index star --aligner star_salmon --pseudo_aligner salmon	21:12:39.819475	\N
113	N6ToA0nkmeMi9xjf	nf-core/RNA-Seq	0	nextflow run nf-core/rnaseq -r 3.3 --input samplesheet_test_local.csv --max_memory 8.GB --max_cpus 8 --genome R64-1-1 --star_index star --aligner star_salmon --pseudo_aligner salmon	09:19:03.058365	\N
114	HKV3XygKPyJ5PGA9	Post-RNA-Seq	\N	\N	10:19:57.818385	\N
115	NaO3X5u3sdykRBg6	Post-RNA-Seq	\N	\N	10:34:01.351406	\N
116	H4CFW6JHUHSvLbb4	nf-core/RNA-Seq	\N	nextflow run nf-core/rnaseq -r 3.3 --input samplesheet_test_local.csv --max_memory 8.GB --max_cpus 8 --genome R64-1-1 --star_index star --aligner star_salmon	10:35:10.215644	\N
117	SodXdJTvY3bDZ2mG	Post-RNA-Seq	0	nextflow run /usr/src/app/nfscripts/post_rnaseq/post_rnaseq_pipeline_scripts_directory_extended_modified_testing_django_1.1.nf --samples 1-samples_extended_no_attributes.tsv --salmon salmon/ --compare 3-chicken_compare.tsv --annotation Gallus_gallus.GRCg6a.104.gtf --network 5-STRING network - Gallus gallus.sif --scripts /usr/src/app/nfscripts/post_rnaseq/scripts/ --species 9031 --organism Gallus gallus --pathways 3 --kmin 0 --kmax 5 --kstep 1 --lmin 0 --lmax 3 --lstep 1 --out /usr/src/app/mediafiles/run/SodXdJTvY3bDZ2mG/output/ --tx2 salmon/tx2gene.csv	10:37:24.072091	00:01:57
118	BoF98bGyYdVRFVkK	Post-RNA-Seq	0	nextflow run /usr/src/app/nfscripts/post_rnaseq/post_rnaseq_pipeline_scripts_directory_extended_modified_testing_django_1.1.nf --samples 1-samples_extended_no_attributes.tsv --salmon salmon/ --compare 3-chicken_compare.tsv --annotation Gallus_gallus.GRCg6a.104.gtf --network 5-STRING network - Gallus gallus.sif --scripts /usr/src/app/nfscripts/post_rnaseq/scripts/ --species 9031 --organism Gallus gallus --pathways 3 --kmin 0 --kmax 5 --kstep 1 --lmin 0 --lmax 3 --lstep 1 --out /usr/src/app/mediafiles/run/BoF98bGyYdVRFVkK/output/ --tx2 salmon/tx2gene.csv	11:00:09.711362	00:02:08
119	5KeTgpyNbSUGCT57	Post-RNA-Seq	\N	nextflow run /usr/src/app/nfscripts/post_rnaseq/post_rnaseq_pipeline_scripts_directory_extended_modified_testing_django_1.1.nf --samples 1-samples_extended_no_attributes.tsv --salmon salmon/ --compare 3-chicken_compare.tsv --annotation Gallus_gallus.GRCg6a.104.gtf --network 5-STRING network - Gallus gallus.sif --scripts /usr/src/app/nfscripts/post_rnaseq/scripts/ --species 9031 --organism Gallus gallus --pathways 3 --kmin 0 --kmax 5 --kstep 1 --lmin 0 --lmax 3 --lstep 1 --out /usr/src/app/mediafiles/run/5KeTgpyNbSUGCT57/output/ --tx2 salmon/tx2gene.csv	11:03:32.770272	\N
120	hUE5G8mAhJr3rE9Q	Post-RNA-Seq	\N	nextflow run post_rnaseq.nf --samples 1-samples_extended_no_attributes.tsv --salmon salmon/ --compare 3-chicken_compare.tsv --annotation Gallus_gallus.GRCg6a.104.gtf --network 5-STRING network - Gallus gallus.sif --scripts scripts/ --species 9031 --organism Gallus gallus --pathways 3 --kmin 0 --kmax 5 --kstep 1 --lmin 0 --lmax 3 --lstep 1 --out output/ --tx2 salmon/tx2gene.csv	11:05:01.015098	\N
121	0XFyfJ3nNhYk4MMN	Post-RNA-Seq	0	nextflow run post_rnaseq.nf --samples 1-samples_extended_no_attributes.tsv --salmon salmon/ --compare 3-chicken_compare.tsv --annotation Gallus_gallus.GRCg6a.104.gtf --network 5-STRING network - Gallus gallus.sif --scripts scripts/ --species 9031 --organism Gallus gallus --pathways 3 --kmin 0 --kmax 5 --kstep 1 --lmin 0 --lmax 3 --lstep 1 --out output/ --tx2 salmon/tx2gene.csv	11:06:33.671715	00:02:00
\.
...
SELECT pg_catalog.setval('public.pipelines_pipeline_id_seq', 10, true);


--
-- Name: run_run_id_seq; Type: SEQUENCE SET; Schema: public; Owner: next_django
--

SELECT pg_catalog.setval('public.run_run_id_seq', 121, true);
...
--
-- Name: run_run run_run_pkey; Type: CONSTRAINT; Schema: public; Owner: next_django
--

ALTER TABLE ONLY public.run_run
    ADD CONSTRAINT run_run_pkey PRIMARY KEY (id);
